...
const SingleEmployer = () => {
    ...
    const getSingleEmployerData = useCallback( async (lang,idx)=>{
        try{
            const {data: { data }}= await getSingleDoctor(lang,idx)
    ...
    return (
        <Layouts>
                    ...
                    <div className="row">
                        <div className="col-md-7 offset-md-5">
                            <div className="doctor-data white-color">
                                <h2 className="h2-xs"> {singleEmployerData.FirstName} {singleEmployerData.LastName} {singleEmployerData.Patronymic}</h2>
                                <h5 className="h5-md"> 
                                    {singleEmployerData.Position}
                                </h5>
                            </div>
                        </div>
                    </div>
            ...
            <EmployerDetails
             biography = {singleEmployerData.Biography && parse(singleEmployerData.Biography)}
